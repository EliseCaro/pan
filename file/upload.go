...
import (
	...
	//"github.com/EliseCaro/pan/account"
	"github.com/EliseCaro/pan/conf"
	fileUtil "github.com/EliseCaro/pan/utils/file"
...
func (u *Uploader) getFileInfo() (LocalFileInfo, error) {
	...
	fileMd5, err := md5FileGet(filePath)
	if err != nil {
		log.Println("md5FileGet failed, err:", err)
		return info, err
	}
...
// 获取文件MD5
func md5FileGet(filePath string) (string, error) {
